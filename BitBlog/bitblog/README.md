...
HEADER and FOOTER are identical for all pages

CONTENT: 

    HOME - 
          -posts
              =>h1 ===> link to post details
              =>div
    ...
    AUTHORS -
          ...
          -authorDetails
              =>link to AUTHORS
              =>div ===> img, name surname, username, email, phone;
              =>div ===> address, street, city, zip;
              =>div ===> company, name, slogan
